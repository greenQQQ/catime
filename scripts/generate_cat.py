...
def generate_prompt_and_story(timestamp: str, creative_notes: dict, character: dict | None = None, crossover_role: str | None = None) -> dict:
    ...
    fallback = {
        ...
        # quota-exhausted hour still renders the right cat (not a random one).
        'prompt': f"A cute cat with the date and time '{timestamp}' displayed in the image, high quality, detailed{character_render_section}",
